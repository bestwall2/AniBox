...
const EpisodeCard = ({ title, description, image, number, imgbup }) => {
  return (
    <div className="bg-zinc-800 h-[75px] transition-all duration-300 ease-out hover:scale-[0.97] rounded-xl shadow-xl flex items-center space-x-[0.5] p-0">
        ...
        <div className="flex flex-col p-2 pt-4 pb-4 overflow-hidden">
